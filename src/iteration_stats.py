...
if __name__ == "__main__":
    ...
    ax_1.set_title(f"Fréquences alléliques du passage {args.iteration}")
    ax_1.legend()
    ...
    ax_2.set_title(f"Profondeur d'aligment du passage {args.iteration}")
    ax_2.legend()
